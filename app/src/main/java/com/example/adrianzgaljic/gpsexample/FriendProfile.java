        ...
        if (action.equals("add")){
            ...
            btnAddFriend.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    String link = Configuration.address+"send_request.php?user="+UserInfo.getUsername()+"&friend="+user;
                    ...
                    btnReject.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            btnReject.setVisibility(View.INVISIBLE);
                            //TODO
                            String link = Configuration.address+"delete_sent_request.php?user="+UserInfo.getUsername()+"&friend="+user;
                            new DBCreateUser(link).execute();
            ...
            btnReject.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    btnAddFriend.setVisibility(View.INVISIBLE);
                    btnReject.setVisibility(View.INVISIBLE);
                    String link = Configuration.address+"delete_request.php?user="+UserInfo.getUsername()+"&friend="+user;
                    new DBCreateUser(link).execute();
            ...
            btnAddFriend.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    String link = Configuration.address+"make_friends.php?user="+UserInfo.getUsername()+"&friend="+user;
                    new DBCreateUser(link).execute();
                    link = Configuration.address+"delete_request.php?user="+UserInfo.getUsername()+"&friend="+user;
                    new DBCreateUser(link).execute();
                    UserInfo.getFriendRequests().remove(user);
                    btnAddFriend.setVisibility(View.INVISIBLE);
                    btnReject.setVisibility(View.INVISIBLE);
            ...
            btnReject.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    btnReject.setVisibility(View.INVISIBLE);
                    //TODO
                    String link = Configuration.address+"end_frendship.php?user=" + UserInfo.getUsername() + "&friend=" + user;
                    new DBCreateUser(link).execute();
